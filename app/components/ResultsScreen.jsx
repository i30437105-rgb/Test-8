...
function getCurrentLevel(blocks) {
  const greenBlocks = blocks.filter(b => b.status === 'success');
  if (greenBlocks.length === 0) return 0;
  return Math.max(...greenBlocks.map(b => b.level));
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          Раздел работает на {percent}% из 100
        </div>
        <div style={{
          fontSize: '11px',
